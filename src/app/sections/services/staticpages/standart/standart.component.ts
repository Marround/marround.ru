...
export class StandartComponent implements OnInit, OnDestroy {
  ...
  constructor(private title: Title, private meta: Meta) {
    this.title.setTitle('Сопровождение "Standard" - Услуги - Marround');
    this.meta.updateTag({name: 'description', content: '☑ Тариф на обслуживание сата "Standard", информация об услуге, список видов работ'});

    this.meta.updateTag({property: 'og:locale', content: 'ru_RU'});
    this.meta.updateTag({property: 'og:title', content: 'Сопровождение "Standard" - Услуги - Marround'});
    this.meta.updateTag({property: 'og:description', content: '☑ Тариф на обслуживание сата "Standard", информация об услуге, список видов работ'});
    this.meta.updateTag({property: 'og:type', content: 'website'});
    this.meta.updateTag({property: 'og:url', content: 'http://marround.ru/services/standard'});
    this.meta.updateTag({property: 'og:image', content: 'http://marround.ru/assets/img/standart.png'});
